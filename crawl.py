...
class GoogleSearchAPI:
    def __init__(self):
        self.api_key = 'AIzaSyDKZLvtz9C5tPbH517yF0jLRm3rPFFH3ik'
        self.custom_search_key = '7e978a8ce9b33aae4'
    
    def search(self, query, **kwargs):
         query_service = build("customsearch", "v1", developerKey=self.api_key)
         query_results = query_service.cse().list(q=query, cx=self.custom_search_key, **kwargs).execute()
         return query_results['items']

    def get_link(self, query, num=5):
